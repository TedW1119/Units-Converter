...
public class Converter {
    ...
    public Converter() {
        ...
        lengthMap.put(lengthUnits[0], 100.0);
        lengthMap.put(lengthUnits[1], 1.0);
        lengthMap.put(lengthUnits[2], 0.001);
        lengthMap.put(lengthUnits[3], 1000000.0);
        lengthMap.put(lengthUnits[4], 1000000000.0);
        lengthMap.put(lengthUnits[5], 0.000621371);
        lengthMap.put(lengthUnits[6], 3.280839895);
        lengthMap.put(lengthUnits[7], 39.370079);
        lengthMap.put(lengthUnits[8], 1.0936132983);
        ...
        weightMap.put(weightUnits[0], 1.0);
        weightMap.put(weightUnits[1], 0.001);
        weightMap.put(weightUnits[2], 0.000001);
        weightMap.put(weightUnits[3], 1000.0);
        weightMap.put(weightUnits[4], 0.0022046244);
        weightMap.put(weightUnits[5], 0.0352739907);
    ...
    // Removes all items originally in ComboBoxes and adds all items in units to ComboBoxes
    ...
    // Checks validity of user input - number only
